...
If Request("PDF") <> 1 Then
	...
	Set rsPrint = Nothing
End If
myPath = "C:\work\LSS-LBIS\web\Images\BC\" & PID & ".jpg"
myBC = PID & ".jpg"
							...
							<table cellSpacing='0' cellPadding='0' width='620px' bgColor='white' border='0'>
								...
								<tr>
									<td class='printForm'>
										...
										<img src="_barcode.asp?code=<%=PID%>&height=20&width=1&mode=code128b&text=0&fileout=<%=myPath%>" style="visibility:hidden" >
									</td>
							...
							<table cellSpacing='0' cellPadding='0' width='620px' bgColor='white' border='0'>
								...
								<tr>
									<td class='printForm'>
										...
										<img src="_barcode.asp?code=<%=PID%>&height=20&width=1&mode=code39&text=0&fileout=<%=myPath%>"  >
