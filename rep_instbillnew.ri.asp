...
sqlRep = "SELECT claimant, judge, amerihealth, meridian, nhhealth, wellsense" & _
...
'End If
sqlRep = sqlRep & "AND [Processed]='2018-10-29' "
...
If Not rsRep.EOF Then 
	...
	Do Until rsRep.EOF
		...
		PayMed = PaytoMedicaid(rsRep("outpatient"), rsRep("hasmed"), rsRep("vermed") _
				, rsRep("autoacc"), rsRep("wcomp"), deptdrg, rsRep("IntrID"), rsRep("medicaid") _
				, rsRep("meridian"), rsRep("nhhealth"), rsRep("wellsense"), rsRep("amerihealth") )
