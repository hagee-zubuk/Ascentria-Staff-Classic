...
ElseIf Request("sino") = 1 Then 'FOR INTERPRETER
	mlMail.Subject="Interpreter Request - " & AppDate & " - " & subInst & " - " & SubCity
	...
	strUrl = "https://app.lssnorth.org/lss-lbis/print.asp?PDF=1&ID=" & Request("HID")
